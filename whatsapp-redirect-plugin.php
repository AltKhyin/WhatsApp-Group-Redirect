<?php
/**
 * Plugin Name: WhatsApp Group Redirect
 * Plugin URI: https://github.com/AltKhyin/WhatsApp-Group-Redirect
 * Description: Automatically redirect form submissions to WhatsApp groups using deep linking to open the mobile app
 * Version: 1.0.0
 * Author: Igor Eckert
 * Author URI: 
 * License:
 * Text Domain: whatsapp-redirect
 *
 * custom redirect endpoint that forces WhatsApp to open in the mobile app
 * rather than the web version. Works with Elementor forms and any form that supports redirect URLs.
 */
...
define('WHATSAPP_DEFAULT_GROUP_LINK', '');
